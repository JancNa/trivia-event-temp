...
import PlaySelectionView from "./components/PlaySelectionView";
  ...
  return (
    <HashRouter>
      <Routes>
        ...
        <Route path="/play-selection" element={<PlaySelectionView />} />
        <Route
      ...
      <main className="max-w-4xl w-full mx-auto my-12 z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-text-body max-w-lg mx-auto leading-relaxed">
            Un portal de gamificación presencial de alta velocidad optimizado
            con los colores corporativos de nuestra marca. Elige un rol a
            continuación:
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Link
            to="/play-selection"
            className="group block relative z-20 bg-bg-subtle border border-border-default hover:border-brand-yellow rounded-3xl p-6 shadow-xl transition-all hover:translate-y-[-4px] cursor-pointer"
            id="portal_play_link"
          >
            ...
            <h3 className="text-lg font-display font-bold text-brand-light mb-2 flex items-center gap-1.5">
              Vista Jugador
              <span className="text-[9px] font-mono font-bold bg-bg-elevated text-text-secondary border border-border-default px-2 py-0.5 rounded-md group-hover:border-brand-yellow/30 group-hover:text-brand-yellow transition-all">
                Mobile
              </span>
            </h3>

            <p className="text-xs text-text-body leading-relaxed mb-6">
              Pensado para que los participantes jueguen desde sus teléfonos
              móviles. Registro de nombre, trivia interactiva de alta fidelidad,
              cálculo de XP y posiciones.
            </p>
          ...
          >
            ...
            <p className="text-xs text-text-body leading-relaxed mb-6">
              Diseño de pantalla completa de alto impacto optimizado para
              proyectores. Podio interactivo 3D del Top 3, buscador con filtros
              y updates automáticos en tiempo real.
            </p>

            <span className="text-xs font-bold text-brand-yellow group-hover:underline flex items-center gap-1.5 uppercase font-mono tracking-wider">
              (Predeterminado) /leaderboard →
            </span>
          </Link>
          ...
          >
            ...
            <p className="text-xs text-text-body leading-relaxed mb-6">
              Panel de administración en vivo. Monitoreo del estado, gestión de
              preguntas (Altas/Bajas), filtrado y exportación de ganadores en
              CSV, y botón de reset.
            </p>
